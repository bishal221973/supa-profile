...
<div class="container">
    <div class="card z-depth-0">
        <div class="card-body">
            <form action="{{route('disability.store')}}" method="POST" class="form">
                @csrf
                 <div class="form-group">
                    <label for="input-name">अपाङ्गता प्रकार</label>
                    <input type="text" id="input-name" name="disability" class="form-control" autocomplete="off" value="{{ old('name') }}">
                </div>
                <div class="form-group">
                    <label for="input-name">अपाङ्गता प्रकार (English)</label>
                    <input type="text" id="input-name" name="disability_en" class="form-control" autocomplete="off" value="{{ old('name') }}">
                </div>
                <div class="form-group">
